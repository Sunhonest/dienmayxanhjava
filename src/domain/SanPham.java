...
public class SanPham {
    ...
    public String getTrangThaiHang() { return trangThaiHang; }
    public void setTrangThaiHang(String trangThaiHang) { this.trangThaiHang = trangThaiHang; }
    public String getTrangThaiKinhDoanh() { return trangThaiKinhDoanh; }
    public void setTrangThaiKinhDoanh(String trangThaiKinhDoanh) { this.trangThaiKinhDoanh = trangThaiKinhDoanh; }
